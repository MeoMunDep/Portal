...
cls
echo =================================================================
echo    Portal BOT SETUP AND RUN SCRIPT by @MeoMunDep
echo =================================================================
echo.
...
if not exist evmAddresses.txt (
    type nul > evmAddresses.txt
    echo Created evmAddresses.txt
)
if not exist bitcoinAddresses.txt (
    type nul > bitcoinAddresses.txt
    echo Created bitcoinAddresses.txt
)
